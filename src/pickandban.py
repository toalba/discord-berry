...
class PickandBan():
    ...
    def __init__(self,rep_a: Member ,rep_b: Member, interaction: Interaction):
        self.uid = uuid.uuid4()
        self.map_pool = None
        self.rep_a = rep_a
        self.rep_b = rep_b
...
class MapbanSelect(ui.Select):
    ...
    def __init__(self, pb: PickandBan):
        ...
        options=[
            SelectOption(label='Ocean',),
            SelectOption(label='Sleeper')
        ]
...
class MapPickSelect(ui.Select):
    ...
    def __init__(self, pb: PickandBan):
        ...
        options=[
            ...
            SelectOption(label='Hotspot'),
            SelectOption(label='Ripost')
...
class PBEmbed(Embed):
    ...
    def __init__(self, *, colour = None, color = Colour.dark_blue(), title = None, type = 'rich', url = None, description = None, timestamp = None):
